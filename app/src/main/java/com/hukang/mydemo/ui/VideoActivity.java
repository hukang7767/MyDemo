...
//            mVideoView.setVideoURI(Uri.parse("http://www.iqiyi.com/v_19rrkycxmg.html?list=19rrkntylq"));
            mVideoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" +R.raw.w));
